...
import { ChatMessage, TachyonResponse, ChatbotWidgetProps } from '../types';
...
export const ChatbotWidget: React.FC<ChatbotWidgetProps> = ({
  ...
  return (
    <div className={`chatbot-container ${positionClass} ${themeClass}`} style={{ '--primary-color': primaryColor } as React.CSSProperties}>
